...
set toPublicize=Assembly-CSharp.dll Assembly-CSharp-firstpass.dll PALSteam.dll PALCore.dll PALPlayFab.dll PALPlayFabSteam.dll PALUnityAuth.dll PALUnityAuthSteam.dll
